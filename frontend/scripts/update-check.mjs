...
try{
  ...
  assert.equal(await page.evaluate(()=>window.portfolioDebug.muted),false);assert.equal(await page.locator('#music').getAttribute('aria-pressed'),'true');
  await page.locator('#music').click();assert.equal(await page.evaluate(()=>window.portfolioDebug.muted),true);assert.equal(await page.locator('#music .mute-slash').isVisible(),true);
  await page.locator('#music').click();assert.equal(await page.evaluate(()=>window.portfolioDebug.muted),false);assert.equal(await page.locator('#music .mute-slash').isVisible(),false);

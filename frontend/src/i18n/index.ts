...
const spanish: Record<string, string> = {
  ...
  'PHOTOSENSITIVITY / SEIZURE WARNING':'ADVERTENCIA SOBRE FOTOSENSIBILIDAD / CONVULSIONES',
  'This experience contains flashing lights, rapidly changing visual effects, and/or high-contrast patterns that may trigger seizures or other adverse reactions in people with photosensitive epilepsy or other visual sensitivities.':'Esta experiencia contiene luces intermitentes, efectos visuales que cambian rápidamente y/o patrones de alto contraste que pueden desencadenar convulsiones u otras reacciones adversas en personas con epilepsia fotosensible u otras sensibilidades visuales.',
  'Viewer discretion is advised.':'Se recomienda discreción al espectador.',
  'DO NOT TURN UP THE VOLUME TO 90 OR MORE IF YOU HAVE EPILEPSY.':'NO SUBAS EL VOLUMEN A 90 O MÁS SI TIENES EPILEPSIA.',
  'YES I AM EPILEPTIC':'SÍ, TENGO EPILEPSIA',
  'DISCO MODE DISABLED':'MODO DISCO DESACTIVADO',
  ...
  'Close controls':'Cerrar controles','A FIELD GUIDE':'GUÍA DE EXPLORACIÓN','At your pace.':'A tu ritmo.',
  ...
  'Approach a landmark to open its notebook. You can type, select text, and scroll inside each notebook.':'Acércate a un lugar para abrir su cuaderno. Puedes escribir, seleccionar texto y desplazarte dentro de cada cuaderno.',
  'Your guide waits nearby. Walk up to chat, or choose a place on the island map for a guided walk.':'Tu guía espera cerca. Acércate para conversar o elige un lugar en el mapa para dar un paseo guiado.',
  ...
  'Companion conversation':'Conversación con tu compañero','Island guide':'Guía de la isla',
  ...
  'Clear history':'Borrar historial','YOUR GUIDE':'TU GUÍA',

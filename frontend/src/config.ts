export const config = {
  ...
  atmosphere: { smoothing: 2, sky: '#9ad7e1', fog: .004, ambient: 1.6, sun: 2.8, sunColor: '#fff0cf', exposure: .85, environmentIntensity: .18, partyCycleSpeed: .18, partySkyMix: .9, partyLightMix: .72, partyFog: .012, partyAmbient: 2.1 },

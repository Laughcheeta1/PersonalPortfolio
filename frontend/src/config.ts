export const config = {
  ...
  atmosphere: { smoothing: 2, sky: '#9ad7e1', fog: .004, ambient: 1.6, sun: 2.8, sunColor: '#fff0cf', exposure: .85, environmentIntensity: .18, partyBeatDuration: .5, partyLightPalette: ['#ff176f', '#823cff', '#00d9ff', '#8cff3f', '#ffd21f'] as const, partySkyScale: .42, partyFog: .012, partyAmbient: 2.1 },
  sky: { clouds: 18, cloudRadius: 100, cloudHeight: 30, cloudDrift: .08, stars: 240, starRadius: 180 },
  audio: { ambientVolume: .065, biomeVolume: .10, musicVolume: .5, partyVolumeThreshold: .9, bufferSeconds: 3, baseFilter: 350, altitudeFilter: 900, blendTime: .5 },

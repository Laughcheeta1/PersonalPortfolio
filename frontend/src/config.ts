export const config = {
  ...
  audio: { ambientVolume: .065, biomeVolume: .10, musicVolume: .5, partyVolumeThreshold: .9, beatFftSize: 1024, beatFrequencyBins: 6, beatThreshold: 1.35, beatMinimumEnergy: .12, beatAverageSmoothing: .08, beatCooldown: .18, bufferSeconds: 3, baseFilter: 350, altitudeFilter: 900, blendTime: .5 },
